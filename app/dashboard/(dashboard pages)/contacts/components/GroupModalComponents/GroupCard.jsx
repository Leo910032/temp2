...
export default function GroupCard({
    ...
    return <FullGroupCard group={group} groups={groups} contacts={contacts} onDelete={onDelete} onEdit={onEdit} onShowLocation={onShowLocation} />;
}
...
function FullGroupCard({ group, groups, contacts, onDelete, onEdit, onShowLocation }) {
                        ...
                        {hasLocation && (
                            <div className="flex items-center gap-2 mt-2">
                                <span className="inline-flex items-center gap-1 text-xs text-gray-600 bg-gray-100 px-2 py-1 rounded-full">
                                    ...
                                    {group.eventLocation.name || 'Event Location'}
                                </span>
                            </div>
                        )}
                    </div>
