...
export default function RulesGenerateTab({
    ...
    const availableOptions = RulesGroupService.getAvailableRulesOptions(subscriptionLevel);
    const featureDescriptions = RulesGroupService.getRulesFeatureDescriptions();
    const comparison = RulesGroupService.getFeatureComparison();

    const updateRulesOptions = useCallback((updates) => {
        if (updateFormState) {
            updateFormState({
                rulesOptions: {
                    ...formState.rulesOptions,
    ...
    }, [updateFormState, formState.rulesOptions]);
                ...
                <div className="space-y-4">
                    ...
                    <div className="bg-gray-50 rounded-lg p-3">
                        ...
                        <div className="text-lg font-semibold text-gray-900">
                            {RulesGroupService.estimateProcessingTime(contacts.length)}
                        </div>
