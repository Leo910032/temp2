...
export const API_COSTS = {
  ...
  // Pinecone Rerank API (Inference)
  // Source: https://www.pinecone.io/pricing/
  // All paid tier models: $2.00 per 1,000 requests
  // Free tier: 500 requests/month included
  PINECONE_RERANK: {
    // Pinecone's state-of-the-art reranking model
    PINECONE_RERANK_V0: {
      PER_1000: 2.00,              // $2.00 per 1,000 requests
      PER_REQUEST: 0.002,
      FREE_TIER_REQUESTS: 500      // 500 requests/month free
    },
    // Multilingual BGE reranker (default)
    BGE_RERANKER_V2_M3: {
      PER_1000: 2.00,              // $2.00 per 1,000 requests
      PER_REQUEST: 0.002,
      FREE_TIER_REQUESTS: 500      // 500 requests/month free
    },
    // Cohere reranker via Pinecone
    COHERE_RERANK_V3_5: {
      PER_1000: 2.00,              // $2.00 per 1,000 requests
      PER_REQUEST: 0.002,
      FREE_TIER_REQUESTS: 0        // Not available on free tier
    }
  },
