...
export class ContactGenerationService {
  ...
  static _enrichContactsWithMetadata(contacts, generatedByAdminId, targetUserId) {
    return contacts.map(contact => ({
      ...contact,
      userId: targetUserId, // Required for Pinecone namespace
      createdBy: targetUserId, // Backward compatibility
      testData: true,
      source: 'admin_test', // Always set to admin_test for admin-generated contacts
      originalSource: contact.source, // Preserve original source for reference
