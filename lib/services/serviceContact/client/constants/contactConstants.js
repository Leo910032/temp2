 ...
 */
// lib/services/serviceContact/client/services/constants/contactConstants.js
...
export const BUSINESS_CARD_AI_CONFIG = {
  // ✅ UPDATED: Switched to the newer, supported model for the v1beta API.
  MODEL_NAME: 'gemini-2.5-flash-lite', 
  
  MODEL_DISPLAY_NAME: 'gemini-2.5-flash-lite',

  // ✅ UPDATED: Corrected pricing for the Gemini 2.0 Flash model.
  ...
  // ✅ UPDATED: Recalculated costs based on 2.0 Flash pricing.
  ESTIMATED_COSTS: {
