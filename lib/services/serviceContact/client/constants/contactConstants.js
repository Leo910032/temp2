...
export const SEMANTIC_SEARCH_CONFIG = {
  ...
  // Rerank configuration - UPDATED TO PINECONE MODELS
  RERANK_MODELS: {
    // Pinecone's state-of-the-art reranking model (multilingual, best performance)
    MULTILINGUAL: 'pinecone-rerank-v0',
    // Alternative: BGE multilingual reranker (also excellent, more lightweight)
    BGE_MULTILINGUAL: 'bge-reranker-v2-m3',
    // Alternative: Cohere reranker via Pinecone (for compatibility)
...
export const CONFIDENCE_THRESHOLDS = {
  ...
  // Cohere rerank scores are different scale than vector scores
