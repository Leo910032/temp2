...
export const SEMANTIC_SEARCH_CONFIG = {
  ...
  // Reason: Pinecone rerank gave very low scores (0.0000-0.0121), Cohere performs better (0.6-0.9)
  RERANK_MODELS: {
    // Cohere's English reranker (best for English queries) - DEFAULT
    ENGLISH: 'rerank-english-v3.0',
    // Cohere's multilingual reranker (100+ languages)
    MULTILINGUAL: 'rerank-multilingual-v3.0',
    // Cohere's v3.5 multilingual reranker (improved, 100+ languages)
    MULTILINGUAL_V35: 'rerank-v3.5',
