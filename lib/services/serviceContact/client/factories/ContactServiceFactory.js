...
// Add to the ContactServiceFactory.js:
static getSemanticSearchService() {
  if (!this.services.has('semanticSearch')) {
    this.services.set('semanticSearch', new SemanticSearchService());
  }
  return this.services.get('semanticSearch');
}
