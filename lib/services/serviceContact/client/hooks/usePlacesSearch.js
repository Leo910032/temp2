...
const placesService = ContactServiceFactory.getPlacesService();
...
export function usePlacesSearch({ onLocationSelect }) {
  ...
  const abortControllerRef = useRef(null); // Although ContactApiClient handles this, good practice to keep.
