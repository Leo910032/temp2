...
export class ContactGroupService extends BaseContactService {
  ...
  async updateContactGroup(groupId, groupData) {
    ...
    const result = await ContactApiClient.put(`/api/user/contacts/groups/${groupId}`, {
      action: 'update',
      group: groupData
    });
  ...
  async addContactsToGroup(groupId, contactIds) {
    ...
    const result = await ContactApiClient.post(`/api/user/contacts/groups/${groupId}/contacts`, {
      action: 'add',
      contactIds
    });
  ...
  async removeContactsFromGroup(groupId, contactIds) {
    ...
    const result = await ContactApiClient.delete(`/api/user/contacts/groups/${groupId}/contacts`, {
