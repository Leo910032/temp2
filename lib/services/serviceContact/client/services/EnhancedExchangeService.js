  ...
  async submitExchangeContact(exchangeData) {
    try {
      ...
      console.log('📋 Mapped submission data:', {
        ...
        dynamicFieldsCount: submissionData.contact?.dynamicFields?.length || 0,
        dynamicFieldsContent: submissionData.contact?.dynamicFields || []
      });

      console.log('🔍 Full contact object being sent:', JSON.stringify(submissionData.contact, null, 2));
