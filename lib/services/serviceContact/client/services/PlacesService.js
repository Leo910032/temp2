...
export class PlacesService {
   ...
   * @param {object} params - { input, sessiontoken, sessionId }
   */
  static async getPredictions(params) {
    try {
      ...
      // Check cache first (cache key includes sessionId to ensure separate caching per session)
      ...
      // Pass all params including sessionId to backend
   ...
   * @param {object} params - { place_id, sessiontoken, sessionId, fields }
   */
