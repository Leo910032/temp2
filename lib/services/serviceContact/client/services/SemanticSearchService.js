...
export class SemanticSearchService extends BaseContactService {
  ...
  static saveSearchJob(query, results, metadata) {
    try {
      ...
      const jobMetadata = { // This is the lightweight summary for the history list
        id: jobId,
        ...
        cacheKey: `search_job_data_${jobId}`, // Points to the full data in localStorage
      ...
      const jobDataToCache = {
        ...
        expiresAt: expiresAt // The expiration timestamp
      };

      // Cache the full results in localStorage instead of the in-memory cache
