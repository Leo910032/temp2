...
export const CONTACT_FEATURES = {
  ...
  BUSINESS_AI_SEARCH: 'business_ai_search',
    BUSINESS_SMART_ICEBREAKERS: 'business_smart_icebreakers', // ✅ ADD THIS
...
export const CONTACT_LIMITS = {
  ...
  [SUBSCRIPTION_LEVELS.PREMIUM]: {
    ...
    features: [
      ...
      CONTACT_FEATURES.PREMIUM_SEMANTIC_SEARCH // ✅ NEW
  ...
  [SUBSCRIPTION_LEVELS.BUSINESS]: {
    ...
    deepAnalysisEnabled: true, // Still no deep analysis
    features: [
      CONTACT_FEATURES.BASIC_CONTACTS,
      CONTACT_FEATURES.BASIC_GROUPS,
      CONTACT_FEATURES.ADVANCED_GROUPS,
      ...
      CONTACT_FEATURES.BUSINESS_AI_SEARCH,
            CONTACT_FEATURES.BUSINESS_SMART_ICEBREAKERS // ✅ ADD THIS
 // ✅ NEW
...
/**
 * Helper function to estimate cost for AI operation (client-side)
 */
export function estimateAICost(modelId, operationCount = 1) {
  return estimateUIOperationCost(modelId, operationCount);
}
...
/**
 * Helper function to get user-friendly feature descriptions
 */
export const AI_FEATURE_DESCRIPTIONS = {
  smartCompanyMatching: {
    name: 'Smart Company Matching',
    description: 'Groups variations like "Microsoft Corp" and "Microsoft Inc"',
    availableFrom: 'Pro'
  },
  industryDetection: {
  ...
  deepAnalysis: {
    ...
    description: 'Uses premium AI for complex insights and strategic relationships',
...
export const GEMINI_PRICING = {
  'gemini-2.5-flash': {
    inputPrice: 0.30,   // $0.10 per 1M input tokens
    outputPrice: 2.50   // $0.40 per 1M output tokens
  },
  'gemini-2.5-pro': {
