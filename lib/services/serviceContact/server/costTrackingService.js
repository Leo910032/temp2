...
export class CostTrackingService {
  ...
  static async recordUsage({
    ...
    try {
      ...
      // **KEY CHANGE**: If a sessionId is provided, ONLY record in SessionUsage
      // Do NOT create entries in AIUsage or ApiUsage collections
      if (sessionId) {
        console.log(`📋 [CostTracking] [${operationId}] Session-based operation - recording ONLY in SessionUsage`);
        ...
        console.log(`✅ [CostTracking] [${operationId}] Session operation recorded`);
