// lib/services/serviceContact/server/index.js - UPDATED
...
export { BusinessCardService } from './businessCardService'; // NEW: Business card service
export { PlacesService } from './placesService';
export { AutoGroupService } from './autoGroupService';
