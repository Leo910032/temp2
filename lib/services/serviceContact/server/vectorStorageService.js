  ...
  static async upsertContactVector(contact, ownerSubscriptionLevel) {
    ...
    try {
      ...
      const metadata = {
        ...
        submittedAt: contact.submittedAt || null,
        lastModified: contact.lastModified || null,
        lastUpdated: new Date().toISOString(),

        // Source tracking
        source: contact.source || 'unknown',
        originalSource: contact.originalSource || null,
        ...
        // Location data
        hasLocation: Boolean(contact.location),
        latitude: contact.location?.latitude || null,
        longitude: contact.location?.longitude || null,

        // Test data markers
        testData: contact.testData || false,
