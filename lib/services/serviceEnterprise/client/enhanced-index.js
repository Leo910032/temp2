...
export const auditService = () => ServiceFactory.getAuditService(); // ✅ Must call the correct method
export const analyticsService = () => ServiceFactory.getAnalyticsService(); // ✅ ADD THIS
