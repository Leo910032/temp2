...
export const DEFAULT_PERMISSIONS_BY_ROLE = {
   [TEAM_ROLES.EMPLOYEE]: {
    ...
    // ✅ FIXED: Removed misleading comments. These are now correctly marked as restricted.
...
export const EMPLOYEE_RESTRICTED_PERMISSIONS = [
  ...
  // ✅ ADDED: Invitation Management is now restricted for employees
...
// ✅ ADD: Missing constants that the component needs
